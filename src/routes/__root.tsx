...
import { I18nProvider } from "@/lib/gboss/i18n";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "G-Boss — Gérer. Organiser. Développer." },
      {
        name: "description",
        content:
          "G-Boss : plateforme privée de gestion d'entreprise — stock, facturation, équipe, tâches, caisse et rapports.",
      },
      { name: "author", content: "G-Boss" },
